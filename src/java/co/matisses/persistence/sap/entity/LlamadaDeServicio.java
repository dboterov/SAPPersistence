...
@Table(name = "OSCL")
@NamedQueries({
    @NamedQuery(name = "LlamadaDeServicio.findAll", query = "SELECT l FROM LlamadaDeServicio l")})
public class LlamadaDeServicio implements Serializable {
    ...
    public LlamadaDeServicio() {
    }

    public LlamadaDeServicio(Integer callID) {
        this.callID = callID;
    }

    public LlamadaDeServicio(Integer callID, short instance, int docNum, String pIndicator, String uNwrRma) {
        this.callID = callID;
    ...
    public Integer getUNumfactura() {
        return uNumfactura;
    }

    public void setUNumfactura(Integer uNumfactura) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LlamadaDeServicio)) {
            return false;
        }
        LlamadaDeServicio other = (LlamadaDeServicio) object;
