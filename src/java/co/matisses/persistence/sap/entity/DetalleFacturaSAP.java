...
@Table(name = "INV1")
@NamedQueries({
    @NamedQuery(name = "DetalleFacturaSAP.findAll", query = "SELECT d FROM DetalleFacturaSAP d")})
public class DetalleFacturaSAP implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected DetalleFacturaSAPPK detalleFacturaSAPPK;
    ...
    public DetalleFacturaSAP(DetalleFacturaSAPPK detalleFacturaSAPPK) {
        this.detalleFacturaSAPPK = detalleFacturaSAPPK;
    }

    public DetalleFacturaSAP(int docEntry, int lineNum) {
        this.detalleFacturaSAPPK = new DetalleFacturaSAPPK(docEntry, lineNum);
    }

    public DetalleFacturaSAPPK getDetalleFacturaSAPPK() {
        return detalleFacturaSAPPK;
    }

    public void setDetalleFacturaSAPPK(DetalleFacturaSAPPK detalleFacturaSAPPK) {
        this.detalleFacturaSAPPK = detalleFacturaSAPPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (detalleFacturaSAPPK != null ? detalleFacturaSAPPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetalleFacturaSAP)) {
            return false;
        }
        DetalleFacturaSAP other = (DetalleFacturaSAP) object;
        if ((this.detalleFacturaSAPPK == null && other.detalleFacturaSAPPK != null) || (this.detalleFacturaSAPPK != null && !this.detalleFacturaSAPPK.equals(other.detalleFacturaSAPPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "co.matisses.sap.entity.DetalleFacturaSAP[ detalleFacturaSAPPK=" + detalleFacturaSAPPK + " ]";
    }
}
