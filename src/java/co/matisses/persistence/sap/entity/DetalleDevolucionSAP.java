...
@Entity
@Table(name = "RIN1")
public class DetalleDevolucionSAP implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected DetalleDevolucionSAPPK detalleDevolucionSAPPK;
    ...
    private Character isByPrdct;
    @Column(name = "ItemType")
    private Integer itemType;
    @Column(name = "PriceEdit")
    private Character priceEdit;
    ...
    private Character invQtyOnly;
    @Column(name = "UnencReasn")
    private Integer unencReasn;
    @Column(name = "U_IVCDone")
    private Character uIVCDone;
    @Column(name = "U_EstadoP")
    private String uEstadoP;
    @Column(name = "U_NWR_Base")
    private String uNWRBase;
    @Column(name = "U_CustDate")
    @Temporal(TemporalType.TIMESTAMP)
    private Date uCustDate;
    @Column(name = "U_NWR_QtyAllocated")
    private BigDecimal uNWRQtyAllocated;
    @Column(name = "U_ReclamQty")
    private BigDecimal uReclamQty;
    @Column(name = "U_QAMark")
    private Character uQAMark;
    @Column(name = "U_IncomingQty")
    ...
    @Column(name = "U_Images")
    private String uImages;
    @Column(name = "U_numPartes")
    private Integer unumPartes;
    @Column(name = "U_Averias")
    private String uAverias;

    public DetalleDevolucionSAP() {
    }

    public DetalleDevolucionSAPPK getDetalleDevolucionSAPPK() {
        return detalleDevolucionSAPPK;
    }

    public void setDetalleDevolucionesSAPPK(DetalleDevolucionSAPPK detalleDevolucionSAPPK) {
        this.detalleDevolucionSAPPK = detalleDevolucionSAPPK;
    }
    ...
    public Character getIsByPrdct() {
        return isByPrdct;
    }

    public void setIsByPrdct(Character isByPrdct) {
    ...
    public Character getPriceEdit() {
        return priceEdit;
    }

    public void setPriceEdit(Character priceEdit) {
    ...
    public Character getInvQtyOnly() {
        return invQtyOnly;
    }

    public void setInvQtyOnly(Character invQtyOnly) {
    ...
    public Character getuIVCDone() {
        return uIVCDone;
    }

    public void setuIVCDone(Character uIVCDone) {
    ...
    public void setuEstadoP(String uEstadoP) {
        this.uEstadoP = uEstadoP;
    }
    ...
    public Date getuCustDate() {
        return uCustDate;
    }

    public void setuCustDate(Date uCustDate) {
    ...
    public void setuNWRQtyAllocated(BigDecimal uNWRQtyAllocated) {
    ...
    public void setuReclamQty(BigDecimal uReclamQty) {
        this.uReclamQty = uReclamQty;
    }

    public Character getuQAMark() {
        return uQAMark;
    }

    public void setuQAMark(Character uQAMark) {
    ...
    public void setuIncomingQty(BigDecimal uIncomingQty) {
    ...
    public Integer getUnumPartes() {
        return unumPartes;
    }

    public void setUnumPartes(Integer unumPartes) {
    ...
    public void setuAverias(String uAverias) {
        this.uAverias = uAverias;
    }

    @Override
    public int hashCode() {
        int hash = 0;
        hash += (detalleDevolucionSAPPK != null ? detalleDevolucionSAPPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetalleDevolucionSAP)) {
            return false;
        }
        DetalleDevolucionSAP other = (DetalleDevolucionSAP) object;
        if ((this.detalleDevolucionSAPPK == null && other.detalleDevolucionSAPPK != null) || (this.detalleDevolucionSAPPK != null && !this.detalleDevolucionSAPPK.equals(other.detalleDevolucionSAPPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "co.matisses.sap.entity.DetalleDevolucionesSAP[ detalleDevolucionSAPPK=" + detalleDevolucionSAPPK + " ]";
    }
}
